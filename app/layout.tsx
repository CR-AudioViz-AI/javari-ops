// app/layout.tsx — javari-ops · CR AudioViz AI · EIN: 39-3646201
import type { Metadata } from 'next'
import './globals.css'
export const dynamic = 'force-dynamic'
export const metadata: Metadata = {
  title: 'Javari Ops | CR AudioViz AI',
  description: 'Platform operations dashboard — CR AudioViz AI, EIN 39-3646201'
}
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en"><body style={{ margin:0,padding:0 }}>
      <div style={{ background:'rgba(0,0,0,0.88)',padding:'6px 20px',display:'flex',alignItems:'center',justifyContent:'space-between' }}>
